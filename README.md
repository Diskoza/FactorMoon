...
- **Оптимизация:** настроенный клиентский набор производительности.
...
Слабые ПК могут запускать сборку, но на первом создании мира и при исследовании новых территорий возможны просадки. Для публикационной версии лучше сразу иметь SSD и не меньше 16 GB общей оперативной памяти.
